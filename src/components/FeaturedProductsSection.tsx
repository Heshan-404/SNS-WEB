  ...
  return (
    <section id="products" className="container mx-auto py-16 px-6 bg-white">
      ...
      <div className="text-center mt-12">
        <Link href="/products">
          <button className="bg-[#1285E8] hover:bg-[#0f6bbd] text-white font-bold py-3 px-8 w-full md:w-auto rounded-lg text-lg transition duration-300 ease-in-out shadow-lg cursor-pointer">
